...
class FreeJobsTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = FreeJobsTestRunner.getenv("FREEJOBS_TEST_LIVE")
        override = FreeJobsTestRunner.getenv("FREEJOBS_TEST_OVERRIDE")
        ...
        explain = FreeJobsTestRunner.getenv("FREEJOBS_TEST_EXPLAIN")
        if explain is not None and explain != "":
            m["FREEJOBS_TEST_EXPLAIN"] = explain
