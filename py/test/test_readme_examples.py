# FreeJobs SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions FreeJobsSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both FreeJobsSDK(...) and FreeJobsSDK.test(...) become
#      FreeJobsSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "freejobs_sdk"
_SDK_CLASS = "FreeJobsSDK"
