...
from freejobs_sdk.utility import register

# Load features
from freejobs_sdk.feature.base_feature import FreeJobsBaseFeature
from freejobs_sdk.features import _has_feature, _make_feature
...
class FreeJobsSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = FreeJobsUtility()
        self._utility = utility

        from freejobs_sdk.config import shared_config
    ...
    def get_utility(self):
        return FreeJobsUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("FreeJobsSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Job(self, data=None) -> "JobEntity":
        ...
        from freejobs_sdk.entity.job_entity import JobEntity
