...
Results: Successful response with job listings.
...
| --- | --- | --- | --- |
| Job | `list` | `GET /jobs` | See reference |

## Connect to the API

- Production server: `https://api.joinrise.io/api/v1`
...
- `free-jobs_list`: List records for an entity. Supported entities: `job`.
- `free-jobs_load`: Load one record for an entity. No active entity supports this operation.
