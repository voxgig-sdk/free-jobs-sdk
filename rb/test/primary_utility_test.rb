...
class PrimaryUtilityTest < Minitest::Test
  ...
  def setup
    @runner = FreeJobsOmni.make_runner(TEST_JSON_FILE, FreeJobsSDK.test(nil, nil))
  ...
  def test_make_point_basic
    ...
    subject = lambda do |ctx|
      ...
      err.nil? ? point : FreeJobsOmni.errify(err)
    end
