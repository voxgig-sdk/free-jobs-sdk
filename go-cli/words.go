...
func registerSDKWords(r *eng.Registry, client *sdk.FreeJobsSDK) {
...
func runOp(client *sdk.FreeJobsSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
