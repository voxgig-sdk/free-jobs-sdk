...
|---|---|---|
| `ts/` | @voxgig-sdk/free-jobs-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/free-jobs-sdk \
      --repository voxgig-sdk/free-jobs-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/free-jobs-sdk` shows it, and
`npm trust revoke @voxgig-sdk/free-jobs-sdk --id=<id>` removes it.
