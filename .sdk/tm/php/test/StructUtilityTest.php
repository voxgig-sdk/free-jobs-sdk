...
// FreeJobs SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = FreeJobsOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(FreeJobsOmni::structfix($now, Struct::undef()))
                        !== json_encode(FreeJobsOmni::structfix($val, Struct::undef()))) {
