...
class FreeJobsProxyFeature extends FreeJobsBaseFeature
{
    ...
    public function init(FreeJobsContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (FreeJobsContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
