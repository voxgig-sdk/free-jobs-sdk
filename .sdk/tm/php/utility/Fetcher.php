...
// FreeJobs SDK utility: fetcher

class FreeJobsFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; FreeJobsSDK/1.0)';
    ...
    public static function call(FreeJobsContext $ctx, string $fullurl, array $fetchdef): array
    {
