...
from projectname_sdk.core.control import FreeJobsControl
...
class FreeJobsContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(r, FreeJobsResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, FreeJobsResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return FreeJobsError(code, msg, self)
