...
class FreeJobsTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = FreeJobsTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = FreeJobsTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = FreeJobsTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")
