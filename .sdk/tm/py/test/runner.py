...
class FreeJobsTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = FreeJobsTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = FreeJobsTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = FreeJobsTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
