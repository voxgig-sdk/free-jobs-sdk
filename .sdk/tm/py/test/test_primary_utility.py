...
from projectname_sdk import FreeJobsSDK
from projectname_sdk.core.spec import FreeJobsSpec
from projectname_sdk.core.result import FreeJobsResult
from projectname_sdk.core.response import FreeJobsResponse
from projectname_sdk.core.operation import FreeJobsOperation
from projectname_sdk.core.error import FreeJobsError
from projectname_sdk.core import helpers
from projectname_sdk.feature.base_feature import FreeJobsBaseFeature
...
class TestPrimaryUtility:
    ...
    def test_feature_init_basic(self):
        init_client = FreeJobsSDK.test(None, None)
        ...
        class TestInitFeature(FreeJobsBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(FreeJobsBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = FreeJobsSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = FreeJobsSDK.test(None, setup_opts)
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = FreeJobsSDK.test(None, setup_opts)
