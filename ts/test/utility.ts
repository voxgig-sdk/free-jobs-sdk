...
function envOverride(m: Record<string, any>) {
  if (
    'TRUE' === process.env.FREEJOBS_TEST_LIVE ||
    'TRUE' === process.env.FREEJOBS_TEST_OVERRIDE
  ) {
  ...
  m.FREEJOBS_TEST_EXPLAIN = process.env.FREEJOBS_TEST_EXPLAIN || m.FREEJOBS_TEST_EXPLAIN
