# FreeJobs TypeScript SDK Reference

Complete API reference for the FreeJobs TypeScript SDK.
...
```ts
new FreeJobsSDK(options?: object)
```
...
#### `FreeJobsSDK.test(testopts?, sdkopts?)`
...
**Returns:** `FreeJobsSDK` instance in test mode.
...
Return the parent `FreeJobsSDK` instance.
