...
describe("JobDirect", function()
  it("should direct-list-job", function()
    local setup = job_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-job", setup.live and "live" or "unit")
