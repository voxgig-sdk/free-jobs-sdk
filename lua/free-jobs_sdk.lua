...
local FreeJobsSDK = {}
FreeJobsSDK.__index = FreeJobsSDK
...
FreeJobsSDK._make_feature = _make_feature


function FreeJobsSDK.new(options)
  local self = setmetatable({}, FreeJobsSDK)
  self.mode = "live"
  self.features = {}
  self.options = nil
...
function FreeJobsSDK:options_map()
...
function FreeJobsSDK:get_utility()
  return Utility.copy(self._utility)
end


function FreeJobsSDK:get_root_ctx()
  return self._rootctx
end


function FreeJobsSDK:prepare(fetchargs)
...
function FreeJobsSDK:direct(fetchargs)
...
-- by passing it.
function FreeJobsSDK:_raw_request(fetchargs)
  local utility = self._utility
...
function FreeJobsSDK:graphql(query, variables, ctrl)
  ...
  if type(errors) == "table" and 0 < #errors then
    ...
    res.ok = false
    res.err = "FreeJobsSDK: graphql: " .. msg
    res.graphql = errors
  end
...
function FreeJobsSDK.test(testopts, sdkopts)
  sdkopts = sdkopts or {}
  ...
  local sdk = FreeJobsSDK.new(sdkopts)
  sdk.mode = "test"
