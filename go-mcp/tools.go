...
type Args struct {
	Entity string         `json:"entity" jsonschema:"job"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.FreeJobsSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "free-jobs_list",
		Description: "List records from FreeJobs. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "free-jobs_load",
		Description: "Load a single record from FreeJobs. " +
...
func runOp(client *sdk.FreeJobsSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.FreeJobsSDK, name string) (sdk.FreeJobsEntity, error) {
