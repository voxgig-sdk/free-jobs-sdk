...
// FreeJobs SDK streaming feature
...
class FreeJobsStreamingFeature extends FreeJobsBaseFeature
{
    ...
    private function _iterate(FreeJobsResult $result): \Generator
    {
    ...
    private function _streamable(FreeJobsContext $ctx): bool
    {
