...
class FreeJobsRbacFeature extends FreeJobsBaseFeature
{
    ...
    private function _required(FreeJobsContext $ctx): ?string
    {
    ...
    private function _reject(FreeJobsContext $ctx, string $required): void
    {
    ...
    private function _track(FreeJobsContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
