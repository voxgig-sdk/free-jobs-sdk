...
// FreeJobs SDK clienttrack feature
...
class FreeJobsClienttrackFeature extends FreeJobsBaseFeature
{
    ...
    public function PostConstruct(FreeJobsContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'FreeJobs-SDK';
