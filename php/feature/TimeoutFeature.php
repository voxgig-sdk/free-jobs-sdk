...
class FreeJobsTimeoutFeature extends FreeJobsBaseFeature
{
    ...
    private function _with_timeout(FreeJobsContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(FreeJobsContext $_ctx, float $ms): void
    {
        $client = $this->client;
