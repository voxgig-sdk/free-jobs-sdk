...
// FreeJobs SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class FreeJobsTestFeature extends FreeJobsBaseFeature
{
    ...
    public function init(FreeJobsContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (FreeJobsContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (FreeJobsContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(FreeJobsContext $ctx, $op, $args): array
    {
