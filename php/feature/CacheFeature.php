...
class FreeJobsCacheFeature extends FreeJobsBaseFeature
{
    ...
    private function _through(FreeJobsContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
