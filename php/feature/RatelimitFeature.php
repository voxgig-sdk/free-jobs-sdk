...
// FreeJobs SDK ratelimit feature
...
class FreeJobsRatelimitFeature extends FreeJobsBaseFeature
{
    ...
    private function _acquire(FreeJobsContext $ctx): void
    {
    ...
    private function _track(FreeJobsContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
