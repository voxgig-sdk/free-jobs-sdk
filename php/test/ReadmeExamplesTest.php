...
// FreeJobs SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (FreeJobsSDK::test)
...
{
    private const SDK_CLASS = 'FreeJobsSDK';
    ...
    private const SDK_BASE = 'freejobs_sdk';
