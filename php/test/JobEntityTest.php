...
class JobEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set FREEJOBS_TEST_JOB_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function job_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("FREEJOBS_TEST_JOB_ENTID");
