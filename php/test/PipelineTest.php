...
{
    private static function utility(): FreeJobsUtility
    {
        return new FreeJobsUtility();
    }
    ...
    private static function ctx(array $over = []): FreeJobsContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new FreeJobsContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new FreeJobsOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof FreeJobsError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new FreeJobsOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = FreeJobsMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new FreeJobsOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = FreeJobsMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new FreeJobsOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = FreeJobsMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new FreeJobsSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = FreeJobsMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new FreeJobsResponse([]),
            'result' => new FreeJobsResult([]),
        ]);
        [, $err] = FreeJobsMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new FreeJobsSpec([]),
            'response' => null,
            'result' => new FreeJobsResult([]),
        ]);
        [, $err] = FreeJobsMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new FreeJobsSpec(['step' => 's']),
            'response' => new FreeJobsResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new FreeJobsResult([]),
        ]);
        [, $err] = FreeJobsMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new FreeJobsSpec(['step' => 's']),
            'response' => new FreeJobsResponse(self::resp(200, ['v' => 1])),
            'result' => new FreeJobsResult([]),
        ]);
        [, $err] = FreeJobsMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new FreeJobsSpec(['step' => 's']),
            'response' => new FreeJobsResponse(self::resp(200, ['v' => 2])),
            'result' => new FreeJobsResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        FreeJobsMakeResponse::call($ctx);
    ...
    {
        $preset = new FreeJobsResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new FreeJobsSpec([]),
            'response' => new FreeJobsResponse([]),
            'result' => new FreeJobsResult([]),
        ...
        [$got, $err] = FreeJobsMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new FreeJobsResult([])]);
        [, $err] = FreeJobsMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new FreeJobsSpec([]), 'result' => null]);
        [, $err] = FreeJobsMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new FreeJobsSpec(['step' => 's']),
            'result' => new FreeJobsResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new FreeJobsOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = FreeJobsMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new FreeJobsSpec(['step' => 's']),
            'result' => new FreeJobsResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new FreeJobsOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = FreeJobsMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new FreeJobsResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new FreeJobsSpec([]),
            'result' => new FreeJobsResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = FreeJobsMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = FreeJobsMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new FreeJobsError('boom', 'boom');
        $utility->fetcher = function (FreeJobsContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new FreeJobsSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = FreeJobsMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (FreeJobsContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = FreeJobsMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(FreeJobsResponse::class, $response);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (FreeJobsContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new FreeJobsSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = FreeJobsMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new FreeJobsResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new FreeJobsSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = FreeJobsMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = FreeJobsMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = FreeJobsMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new FreeJobsResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, FreeJobsDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new FreeJobsResult(['ok' => false])]);
        $this->expectException(FreeJobsError::class);
        FreeJobsDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new FreeJobsResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', FreeJobsMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        FreeJobsMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new FreeJobsBaseFeature();
        $b = new FreeJobsBaseFeature();
        FreeJobsFeatureAdd::call($ctx, $a);
        FreeJobsFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): FreeJobsBaseFeature
    {
        $f = new FreeJobsBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        FreeJobsFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): FreeJobsContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new FreeJobsSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = FreeJobsPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new FreeJobsResponse(['headers' => null]),
            'result' => new FreeJobsResult([]),
        ]);
        FreeJobsResultHeaders::call($ctx);
