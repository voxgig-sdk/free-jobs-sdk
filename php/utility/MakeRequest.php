...
// FreeJobs SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class FreeJobsMakeRequest
{
    public static function call(FreeJobsContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new FreeJobsResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new FreeJobsResponse($fetched);
        } else {
