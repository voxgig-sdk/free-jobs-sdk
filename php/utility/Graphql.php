...
class FreeJobsGraphql
{
    ...
    // equivalent.
    public static function body(FreeJobsContext $ctx): mixed
    {
    ...
    public static function errors(FreeJobsContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
