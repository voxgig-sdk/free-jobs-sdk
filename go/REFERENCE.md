# FreeJobs Golang SDK Reference

Complete API reference for the FreeJobs Golang SDK.
...
#### `TestSDK(testopts, sdkopts map[string]any) *FreeJobsSDK`
...
#### `Job(data map[string]any) FreeJobsEntity`
