...
func (sdk *FreeJobsSDK) OptionsMap() map[string]any {
...
func (sdk *FreeJobsSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *FreeJobsSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *FreeJobsSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *FreeJobsSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *FreeJobsSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *FreeJobsSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("FreeJobsSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *FreeJobsSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *FreeJobsSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("FreeJobsSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
